...
#   - Discovers SSL checkpoints in ssl_ckpts_v2/seqlen_{sl}/
...
# 0) CONFIG (edit here)
# ----------------------------
SEEDS_TO_RUN = [1, 2, 3]  # seed 0 fully done for seqlen_30

SSL_MANIFEST_DIR = "./ssl_ckpts_v2"
DATA_GLOB = "/home/ql84/Transformer/csv_data/**/*.csv"
PT_DATA_DIR = "./pt_data"
SFT_OUT_DIR = "./sft_posttrain_v3"

# SSL steps to use for SFT — per-seq_len mapping
SSL_STEPS_PER_SEQLEN = {
    # 3: [20_000, 50_000, 100_000],   # DONE
    # 5: [20_000, 50_000, 100_000],   # DONE
    # 8: [20_000, 50_000, 100_000],   # DONE
    # 10: [20_000, 50_000, 100_000],  # DONE
    # 20: [20_000, 50_000, 100_000],  # DONE
